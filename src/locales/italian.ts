const Italian = {
  translation: {
    common: {
      ...
      approve: 'Approva',
      claim: 'Richiedi',
      clamPrice: 'Prezzo di NJORD',
      connectWallet: 'Connetti il Wallet',
      price: 'Prezzo',
      buy: 'Compra',
      buyThing: 'Compra ', //e.g. "Buy NJORD", "Buy sNJORD"
    ...
    dashboard: {
      ...
      tooltipInfoMessages: {
        tvl: "Valore Totale Bloccato, è l'importo in dollari di tutti i NJORD in stake nel protocollo. Questa metrica è spesso usata come indicatore di crescita o di salute nei progetti DeFi.",
        mvt: 'Valore di Mercato degli Asset del Treasury, è la somma del valore (in dollari) di tutti gli asset posseduti dal tesoro.',
        rfv: "Valore Risk Free, è l'importo di fondi che il tesoro usa a garanzia di NJORD.",
    ...
    migrate: {
      ...
      oldClamSupply: 'Vecchia Fornitura di NJORD ',
      oldTreasuryReserve: 'Vecchia Riserva del Tesoro',
      migrationProgress: 'Avanzamento della Migrazione',
      connectWalletDescription: 'Connetti il tuo wallet per migrare i tuoi token NJORD !',
      steps: 'Passi',
      yourAmount: 'Il tuo importo',
      claimWarmup: 'Claim Warmup',
      done: 'FINITO',
      unstakeClam: 'Unstake NJORD',
      migrateTo: 'Migra da NJORD a NJORD',
      estimatedClamTwo: 'NJORD Stimati ',
      yourClamTwoBalance: 'Il tuo bilancio in NJORD',
    },
    // src\views\Bond
    bonds: {
      ...
      purchase: {
        ...
        fourFourInfo:
          "Nota: Il bond (4, 4) metterà in staking tutti i NJORDs all'inizio, quindi guadagnerai tutte le ricompense di rebase durante il periodo di acquisizione. A acquisizione completata, potrai soltanto fare il claim di sClam.",
        approvalInfo:
    ...
    landing: {
      ...
      splashPage: {
        howModoFinanceWorks: 'Come funziona ModoFinance',
    ...
    stake: {
      ...
      connectWalletDescription: 'Connetti il tuo wallet per mettere in stake token NJORD!',
      approvalInfo:
    ...
    calculator: {
      ...
      yoursClamBalance: 'Il tuo bilancio in sNJORD',
      sClamAmount: 'Quantità di sNJORD',
      purchasePrice: "Prezzo di NJORD all'acquisto ($)",
      futurePrice: 'Prezzo di Mercato futuro di NJORD ($)',
      results: 'Risultati',
      initialInvestment: 'Il tuo investimento iniziale',
      currentWealth: 'Salute corrente',
      rewardEstimation: 'Stima delle ricompense in NJORD',
