const Tagalog = {
  translation: {
    common: {
      ...
      approve: 'Aprubahan',
      claim: 'Claim',
      clamPrice: 'Presyo ng NJORD',
      connectWallet: 'ikonekta ang pitaka',
      price: 'Presyo',
      buy: 'Bumili',
      buyThing: 'Bumili ng ', //e.g. "Bumili ng NJORD", "Bumili ng sNJORD"
    ...
    dashboard: {
      ...
      backingPerClam: 'Backing bawat NJORD',
      ...
      tooltipInfoMessages: {
        tvl: 'Kabuuang depositong halaga, ay ang halaga ng dolyar ng lahat ng NJORD na naka-stake sa protocol. Ang metrika na ito ay kadalasang ginagamit na sukat ng pag-unlad o kalusugan ng mga proyekto ng DeFi.',
        mvt: 'Halaga ng Merkado ng Treasury Assets, ay ang kabuuan ng halaga (dolyar) ng lahat ng pag-aaring hawak ng treasury.',
        rfv: 'Risk Free Value, ay ang halaga ng pondo na ginagamit sa paggarantiya ng treasury sa pagsuporta ng NJORD.',
    ...
    migrate: {
      migration: 'Migrasyon',
      oldClamSupply: 'Lumang Suplay ng NJORD',
      oldTreasuryReserve: 'Lumang reserba ng Treasury',
      migrationProgress: 'Progreso ng Migrasyon',
      connectWalletDescription: 'Ikonekta ang Iyong Pitaka para Ma-migrate ang Iyong NJORD tokens!',
      steps: 'mga Hakbang',
      yourAmount: 'Iyong Halaga',
      claimWarmup: 'Kunin ang Warmup',
      done: 'Tapos',
      unstakeClam: 'Unstake NJORD',
      migrateTo: 'Migrate NJORD to NJORD',
      estimatedClamTwo: 'Estimated NJORD ',
      yourClamTwoBalance: 'Balanse ng Iyong NJORD',
    },
    // src\views\Bond
    bonds: {
    ...
    stake: {
      ...
      connectWalletDescription: 'Ikonekta ang Iyong Pitaka para mag-stake ng NJORD tokens!',
      approvalInfo:
    ...
    calculator: {
      ...
      purchasePrice: 'Presyo ng NJORD nung binili ($)',
      futurePrice: 'Presyo ng NJORD sa susunod ($)',
      results: 'Resulta',
