const Norwegian = {
  translation: {
    common: {
      ...
      approve: 'Godkjenn',
      claim: 'Krev inn',
      clamPrice: 'Pris per NJORD',
      connectWallet: 'Koble til Wallet',
      price: 'Pris',
      buy: 'Kjøp',
      buyThing: 'Kjøp ', //e.g. "Buy NJORD", "Buy sNJORD"
    ...
    dashboard: {
      ...
      tooltipInfoMessages: {
        tvl: 'Total Value Locked (TVL), er dollarverdien av alle NJORD  som er staket i protokollen. Denne beregningen er ofte brukt som en vekst- eller helse-indikator i DeFi prosjekter.',
        mvt: 'Markedsverdi på verdireservene er formueverdien i dollar på alle aktiva i verdireservene.',
        rfv: 'Risikofri verdi på verdireservene er formueverdien i dollar på alle aktiva i verdireservene som man kan garantere støtter opp NJORD.',
        ...
        holder: 'Holdere, er det totale antalle Oters (sNJORD holdere)',
        staked: 'Prosent staket, er forholdet mellom sNJORD og NJORD (Mengde staket per ustakede tokens)',
        ...
        runway: 'Runway er antall dager nåværende justeringsutslipp på sNJORD kan vedvare. Lavere APY = lenger runway',
        currentIndex:
          'Nåværende index sporer mengden sNJORD som er akumulert siden stakingen begynte. Altså hvor mange sNJORD man ville hatt hvis man staket en stk NJORD fra første stund.',
      },
    },
    // src\views\Migrate
    migrate: {
      migration: 'Migrering',
      oldClamSupply: 'Gammel NJORD i omløp',
      oldTreasuryReserve: 'Gamle Verdireserver',
      migrationProgress: 'Migrasjonsfremgang',
      connectWalletDescription: 'Koble din crypto-wallet for å migrere dine gamle NJORD token!',
      steps: 'Steg',
      yourAmount: 'Din Saldo',
      claimWarmup: 'Krev inn warmup-tokens',
      done: 'FERDIG',
      unstakeClam: 'Avstak dine NJORD',
      migrateTo: 'Migrere NJORD til NJORD',
      estimatedClamTwo: 'Estimerte NJORD ',
      yourClamTwoBalance: 'Din NJORD Saldo',
    },
    // src\views\Bond
    bonds: {
    ...
    stake: {
      ...
      connectWalletDescription: 'Koble til din crypto-wallet for å stake NJORD!',
      approvalInfo:
    ...
    calculator: {
      ...
      yoursClamBalance: 'Din sNJORD saldo',
      sClamAmount: 'sNJORD Beløp',
      purchasePrice: 'NJORD Pris ved kjøp ($)',
      futurePrice: 'NJORDs fremtidige pris ($)',
      results: 'Resultater',
      initialInvestment: 'Din opprinnelige investering',
      currentWealth: 'Nåværende formue',
      rewardEstimation: 'NJORD gevinst estimat',
