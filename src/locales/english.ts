const English = {
  translation: {
    common: {
      ...
      clamPrice: 'NJORD Price',
      FJORDPrice: 'FJORD Price',
      connectWallet: 'Connect Wallet',
      price: 'Price',
      buy: 'Buy',
      buyThing: 'Buy ', //e.g. "Buy NJORD", "Buy NJORD"
    ...
    dashboard: {
      ...
      backingPerClam: 'Backing per NJORD',
      ...
      tooltipInfoMessages: {
        tvl: 'Total Value Deposited, is the dollar amount of all NJORD staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.',
        mvt: 'Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.',
        rfv: 'Risk Free Value, is the amount of funds the treasury guarantees to use for backing NJORD.',
    ...
    stake: {
      ...
      connectWalletDescription: 'Connect your wallet to stake NJORD tokens!',
      approvalInfo:
    ...
    calculator: {
      ...
      yoursClamBalance: 'Your NJORD Balance',
      sClamAmount: 'NJORD Amount',
      purchasePrice: 'NJORD Price at Purchase ($)',
      futurePrice: 'Future NJORD Market Price ($)',
      results: 'Results',
      initialInvestment: 'Your initial investment',
      currentWealth: 'Current wealth',
      rewardEstimation: 'NJORD rewards estimation',
    ...
    pearlChests: {
      title: 'FJORD Chests',
      description:
        'FJORD Chests are like personal vaults where you can lock your FJORDs. Once your FJORDs are put into a Chest, they will be locked for a certain period of time, but will also yield a lot more NJORDs.',
      readMore: 'Read More',
      locked: 'Locked',
      unlocked: 'Unlocked',
      ...
      apy: 'APY',
      addPearl: 'Add FJORD',
      claimRewardAndRelock: 'Claim & Relock ({{amount}} FJORD)',
      claimReward: 'Claim Reward',
      redeemAll: 'Redeem All',
      claimAllAndRelock: 'Claim all & Relock',
      lockUpModal: {
        title: 'FJORD Chest Lock-up',
      },
      lockUp: {
        tabLabel: 'Lock up',
        title: 'Compare All FJORD Chests',
        days: 'days',
        boost: 'Boost',
      ...
      redeem: {
        tabLabel: 'Redeem',
        connect: 'Connect your wallet to view your FJORD Chests!',
      },
    },
  },
};
