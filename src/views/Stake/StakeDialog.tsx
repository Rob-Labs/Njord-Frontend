            ...
            <div className="amt-msg">
              {action === `stake` ? (
                <div className="rcv">
                  ...
                  <span className="quantity">{quantity}</span> sNJORD!
                </div>
              ) : (
                <div className="rcv">
                  {t('stake.youReceived')} <span className="quantity">{quantity}</span> NJORD!
                </div>
              )}
            </div>
              ...
              <div className={`${styles.detailContent} dtl-wrap`}>
                <Grid container className="dtl">
                  ...
                  <Grid item xs={6} md={6} className="dtl-value">
                    <div>{balance} NJORD</div>
                  </Grid>
                  <Grid item xs={6} md={6}>
                    <div>{t('stake.stakedBalance')}</div>
                  </Grid>
                  <Grid item xs={6} md={6} className="dtl-value">
                    <div>{stakeBalance} sNJORD</div>
                  </Grid>
                  <Grid item xs={6} md={6}>
                    <div>{t('stake.nextRewardAmount')}</div>
                  </Grid>
                  <Grid item xs={6} md={6} className="dtl-value">
                    <div>{nextRewardValue} sNJORD</div>
                  </Grid>
                  <Grid item xs={6} md={6}>
