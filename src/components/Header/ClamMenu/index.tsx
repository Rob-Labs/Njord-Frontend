...
import { ReactComponent as ClamIcon } from '../../../assets/icons/NJORD.svg';
      ...
      await window.ethereum.request({
        ...
        params: {
          ...
          options: {
            ...
            symbol: tokenSymbol,
            decimals: tokenSymbol === 'FJORD' ? 18 : TOKEN_DECIMALS,
            image: tokenImage,
          },
        },
      });
...
const BuyButton = ({ text }: { text: string }) => {
  ...
  return <CustomButton type="outline" icon={ClamIcon} text={`${text} NJORD`} />;
};
...
function ClamMenu() {
  ...
  const { NJORD_ADDRESS, FJORD_ADDRESS } = addresses;
