...
export const Web3ContextProvider: React.FC<{ children: ReactElement }> = ({ children }) => {
  ...
  const _checkNetwork = (otherChainID: number): Boolean => {
    if (Number(otherChainID) !== Networks.TBSC) {
      alert('Please switch your wallet to BSC Tesnet network to use NjordFinance!');
    }
    // if (Number(otherChainID) !== Networks.BSC) {
    //   alert('Please switch your wallet to BSC network to use NjordFinance!');
    // }
